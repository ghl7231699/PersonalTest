...
class LogHookConfig {
    ...
    //日志采集埋点入口类(插入类的全类名)
    public static final String LOG_ANALYTICS_BASE = "com/xzdz/injectlib/inject/AutoTrackHelper"
     ...
     * Fragment中的方法
     */
    public final static HashMap<String, LogMethodCell> sFragmentMethods = new HashMap<>()
    static {
     ...
     * activity中的方法
     */
    public final static HashMap<String, LogMethodCell> sActivityMethods = new HashMap<>()
...
//                [Opcodes.ALOAD]))
     ...
     * application中的方法
     */
    public final static HashMap<String, LogMethodCell> sApplicationMethods = new HashMap<>()
